...
<main>
   <?php $featuredImageURL = get_the_post_thumbnail_url(get_the_ID(), 'full');?>
    <section class="lead-page-section contact-lead-section" style="background-image: url(<?php echo $featuredImageURL ?>);">
